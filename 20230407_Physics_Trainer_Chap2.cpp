...
void Excersize_2_5(int solution, int answer)
{
	...
	if (solution == SHOW)
	{
		printf("\n\n\n");
		printf("=================================================================\n");
		printf("관련 공식은 V = (xf - xi) / (tf - ti)입니다.\n");

		time1 = distance1 / velocity1;
		printf("어떤 사람이 고속도로를 처음 200km는 90km/h의 속력으로 달릴때 %.0lf는 다음과 같습니다.\n", time1);

		time2 = distance2 / velocity2;
		printf("어떤 사람이 고속도로를 처음 200km는 50km/h의 속력으로 달릴때 %.0lf는 다음과 같습니다.\n\n", time2);
	...
	if (answer == SHOW)
	{
		...
		printf("(a) 이 사람의 여행과정에서 평균 속력은 얼마인가? \n");
        printf("이 사람의 여행과정에서 평균 속력은 다음과 같습니다. : %.0lf \n", average_velocity);
		printf("=================================================================\n");
		printf("\n\n\n");
	}
	...
	if (solution == SHOW)
	{
		...
		printf("어떤 사람이 어떤 장소를 갔다가 되돌아 왔기 때문에 %0.lf은 다음과 같습니다.\n\n", displacement);
	...
	if (answer == SHOW)
	{
		...
		displacement = distance1 - distance2;
		printf("(b) 이 사람의 여행과정에서 평균 속도은 얼마인가?\n");
		printf("(b) 이 사람의 여행과정에서 평균 속도는 다음과 같습니다. : %.0lf \n", displacement);
