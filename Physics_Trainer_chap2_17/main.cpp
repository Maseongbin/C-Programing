...
{
    double east_velocity = 6.0; //동쪽으로 갈 때 속도
    double west_velocity = 4.0; //서쪽으로 갈 때 속도
    double delta_velocity;
    double delta_time;
    double time1 = 10; //방향 변환 전 걸린 시간
    double time2;
    ...
    if (solution == SHOW)
    {
        ...
        printf("t  = (0m/s - %6.2lfm/s) / %6.2lfm/s^2\n", east_velocity, acceleration);
        printf("   = %6.2lfs\n\n", time2);
    ...
    if (solution == SHOW)
    {
        ...
        printf("Δx = (0^2 - %6.2lfm/s^2) / 2 * %6.2lfm/s^2\n", east_velocity, acceleration);
        printf("   = %6.2lfm\n\n", distance1);
    ...
    if (solution == SHOW)
    {
        ...
        printf("Δx = ((%6.2lfm/s)^2 - 0)) / 2 * %6.2lfm/s^2\n", west_velocity, acceleration);
        printf("   = %6.2lfm\n\n", distance2);
    ...
    if (answer == SHOW)
    {
        ...
        printf("이동한 거리 = %6.2lfm + %6.2lfm\n", distance1, fabs(distance2));
        printf("            = %6.2lfm\n\n", distance3);

        printf("변위        = %6.2lfm + (%6.2lfm)\n", distance1, distance2);
        printf("            = %6.2lfm\n", distance3);
